...
void run()
{
    ...
    Assembly<n_layer> pt_ass{"../geometry/geo1_2DSQ_Shear.dump", "../geometry/geo1_2DSQ_Shear.bond", cell, ParticleType::Elastic}; // read coordinate from local files
    ...
    std::string dumpFile{"Shear_2d_crack_sq_bond.dump"}; // output file name
